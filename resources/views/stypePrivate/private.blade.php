...
<section id="private">
    <div class = "main-container">
        <h1>Privately Funded Scholarships</h1>
        <p>Unlock Your Potential with Private Scholarships</p>
        <div class = "filter-container">
            <div class = "category-head">
                <ul>
                    <div class = "category-title actives" id = "all">
                        <li>All</li>
                        <span><i class = "fas fa-border-all"></i></span>
                    </div>
                    <div class = "category-title" id = "culture">
                        <li>Culture, Arts, Humanities</li>
                        <span><i class = "fas fa-theater-masks"></i></span>
                    </div>
                    <div class = "category-title" id = "politics">
                        <li>Social Sciences and Politics</li>
            ...
            <div class = "posts-collect">
                <div class = "posts-main-container">
                    ...
                    <div class = "all business">
                        <div class = "post-img">
                            <img src = "/image/private-scholarship.jpg" alt = "post">
                            <span class = "category-name">Business, Management, Marketing</span>
                        </div>
                        ...
                        <button type = "button" class = "read-btn">Apply Now</button>
                    </div>
                    <!-- end of single post -->
                    <!-- single post -->
                    <div class = "all business">
                    ...
                    <div class = "all culture">
                        <div class = "post-img">
                            <img src = "/image/private-scholarship.jpg" alt = "post">
                            <span class = "category-name">Culture, Arts, Humanities</span>
                        </div>
                    ...
                    <div class = "all finance">
                        <div class = "post-img">
                            <img src = "/image/private-scholarship.jpg" alt = "post">
                            <span class = "category-name">Accounting and Finance</span>
                        </div>
                    ...
                    <div class = "all politics">
                        <div class = "post-img">
                            <img src = "/image/private-scholarship.jpg" alt = "post">
                            <span class = "category-name">Social Sciences and Politics</span>
                        </div>
