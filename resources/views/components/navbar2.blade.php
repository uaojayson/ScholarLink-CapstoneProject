    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse mx-4" id="navbarTogglerDemo02">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            <a
              class="nav-link dropdown-toggle {{ Request::is('stypePrivate') ? 'active' : '' }}"
              href="#"
              role="button"
              onclick="setActiveLink(this)"
            ...
            <ul class="dropdown-menu">
                ...
                <li><hr class="dropdown-divider" /></li>
              <li>
                <a class="dropdown-item" href="{{route('ngo')}}">NGO Funded</a>
              </li>
              <li><hr class="dropdown-divider" /></li>
             
              <li><a class="dropdown-item" href="{{route('gov')}}">Government Funded</a></li>
